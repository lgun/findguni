...
CREATE TABLE escape_games (
    ...
    unlimited_hints BIT NOT NULL DEFAULT TRUE,
    hint_limit INT NOT NULL DEFAULT 3,
    hint_cooldown_seconds INT NOT NULL DEFAULT 0,
...
CREATE TABLE game_stages (
    ...
    required_items LONGTEXT,
    consume_required_items BIT NOT NULL DEFAULT FALSE,
...
CREATE TABLE game_items (
    ...
    initially_owned BIT NOT NULL DEFAULT FALSE,
    copyable_text VARCHAR(1000),
    alternate_required_item VARCHAR(36),
    alternate_scan_text LONGTEXT,
    PRIMARY KEY (id),
...
CREATE TABLE play_sessions (
    ...
    revealed_hints_json LONGTEXT,
    last_hint_at DATETIME(6),
    entity_version BIGINT NOT NULL,
    PRIMARY KEY (id),
